...
# Lines
def lines(data, title="", xlabel="", ylabel="", label="Lines", x_ticks=None, savefig=True, figpath=default_dir, filename="lines_plot", format=default_format, grid=True, legend=True, clear=True, show=True, normalize=True, color=default_color, stackableplot=False):
...
def scatter(x_data, y_data, title="", xlabel="", ylabel="", label="Scatters", savefig=True, figpath=default_dir, filename="scatter_plot", format=default_format, grid=True, legend=True, clear=True, show=True, normalize=True, color=default_color, stackableplot=False, marker="o"):

    if clear:
        plt.gcf().clear()

    plt.scatter(x_data, y_data, label=label, marker=marker, norm=normalize, c=color)
