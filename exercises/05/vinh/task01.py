...
# Returns a dictionary that contains the testset and its features combined with the probability generated by knn.
...
def task1():
    ...
    # 1b
    result = binary_prediction(indices_test_sorted, knn_dict["knn"])
    # 1c
    reply_task_1c()
